            ...
            <div class="espaco-radio col-md-3 col-xs-12">
                <div class="input-group">
                    <span class="meu-grupo-addon input-group-addon">
                        <input type="radio" aria-label="televisao selecionar" name="produto" value="televisao" checked> Televisão
                    </span>
                </div>
            </div>
            <div class="espaco-radio col-md-3 col-xs-12">
                <div class="input-group">
                    <span class="meu-grupo-addon input-group-addon">
                        <input type="radio" aria-label="geladeira selecionar" name="produto" value="geladeira"> Geladeira
                    </span>
                </div>
            </div>
            <div class="espaco-radio col-md-3 col-xs-12">
                <div class="input-group">
                    <span class="meu-grupo-addon input-group-addon">
                        <input type="radio" aria-label="televisao selecionar" name="produto" value="fogao"> Fogão
                    </span>
                </div>
            </div>
            <div class="espaco-radio col-md-3 col-xs-12">
                <div class="input-group">
                    <span class="meu-grupo-addon input-group-addon">
                        <input type="radio" aria-label="televisao selecionar" name="produto" value="microondas"> Microondas
                    </span>
                </div>
            </div>
        </div>
